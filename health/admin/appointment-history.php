	...
	<body>
		<!-- end: TOP NAVBAR -->
				<div class="main-content" >
					...
					<a href="dashboard.php" style="float:right; margin-right:30px; margin-top:20px; color:#342C46; font-size:20px;">Back</a>
						<!-- start: PAGE TITLE -->
						<section id="page-title">
							<div class="row">
										<h1 align="center">Manage appointment</h1>
							</div>
						</section>
						<!-- end: PAGE TITLE -->
						<!-- start: BASIC EXAMPLE -->
						<div class="container-fluid container-fullw bg-white">
								...
								<div class="col-md-12">
										...
										<thead>
											<table align="center" width="85%" border="8" style="margin-top:15px;" >
		<tr style="background-color:#000; color:#fff;">
											<tr>
												<th class="center">#</th>
												<th class="hidden-xs">Specilization</th>
												<th>Patient Name</th>
												<th>Doctor Fee</th>
